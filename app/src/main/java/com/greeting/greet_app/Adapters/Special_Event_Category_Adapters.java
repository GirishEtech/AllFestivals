...
public class Special_Event_Category_Adapters extends RecyclerView.Adapter<Special_Event_Category_Adapters.StudentsViewHolder> {
    ...
    public Special_Event_Category_Adapters(Context context, ArrayList<CategoryModel> clientModelArrayList) {
        inflater=LayoutInflater.from(context);
        this.context = context;
        this.clientModelArrayList = clientModelArrayList;
    }
    public Special_Event_Category_Adapters(Context context, ArrayList<CategoryModel> clientModelArrayList, EventListener listener) {
        inflater=LayoutInflater.from(context);
        this.context = context;
        this.clientModelArrayList = clientModelArrayList;
    ...
    public StudentsViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.special_event_item2,parent,false);
