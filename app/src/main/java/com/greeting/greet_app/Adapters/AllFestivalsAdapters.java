...
public class AllFestivalsAdapters extends RecyclerView.Adapter<AllFestivalsAdapters.StudentsViewHolder> {
    ...
    public AllFestivalsAdapters(Context context, ArrayList<CategoryModel> clientModelArrayList) {
        inflater=LayoutInflater.from(context);
        this.context = context;
        this.clientModelArrayList = clientModelArrayList;
    }
    public AllFestivalsAdapters(Context context, ArrayList<CategoryModel> clientModelArrayList, EventListener listener) {
        inflater=LayoutInflater.from(context);
        this.context = context;
        this.clientModelArrayList = clientModelArrayList;
    ...
    public StudentsViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.all_festivels,parent,false);
