...
public class AllFestivals_Category_Adapters extends RecyclerView.Adapter<AllFestivals_Category_Adapters.StudentsViewHolder> {
    ...
    public AllFestivals_Category_Adapters(Context context, ArrayList<CategoryModel> clientModelArrayList) {
        inflater=LayoutInflater.from(context);
        this.context = context;
        this.clientModelArrayList = clientModelArrayList;
    }
    public AllFestivals_Category_Adapters(Context context, ArrayList<CategoryModel> clientModelArrayList, EventListener listener) {
        inflater=LayoutInflater.from(context);
        this.context = context;
        this.clientModelArrayList = clientModelArrayList;
    ...
    public StudentsViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.all_festivel_item,parent,false);
          ...
          //  holder.img.setImageResource(model.getImage());
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(context, AllCategory_Activity.class);
