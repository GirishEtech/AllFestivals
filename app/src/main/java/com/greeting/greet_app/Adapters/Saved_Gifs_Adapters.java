...
public class Saved_Gifs_Adapters extends RecyclerView.Adapter<Saved_Gifs_Adapters.StudentsViewHolder> {
    Context context;
    ArrayList<String> list;
    private LayoutInflater inflater;
    String type="";

    public Saved_Gifs_Adapters(Context context, ArrayList<String> clientModelArrayList) {
