 ...
 */
public class Saved_Cards_Fragment extends Fragment {
    ...
    public static Saved_Cards_Fragment newInstance(String param1, String param2) {
        Saved_Cards_Fragment fragment = new Saved_Cards_Fragment();
