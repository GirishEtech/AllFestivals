 ...
 * Use the {@link Saved_Sticker_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Saved_Sticker_Fragment extends Fragment {
    ...
    public static Saved_Sticker_Fragment newInstance(String param1, String param2) {
        Saved_Sticker_Fragment fragment = new Saved_Sticker_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gifs_adapters =new Saved_Cards_Adapters(activity,list,Utils.Stickers);
    ...
    private void Get_Saved_Items() {
        ...
        UserSavedref.child(android_id).child(Utils.Stickers).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void loadDownloaded() {
        try {
            ...
            File fileroot = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).toString()+"/"+getString(R.string.app_name)+"/"+Utils.Stickers);
