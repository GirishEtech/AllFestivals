...
public class Saved_Frames_Fragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gifs_adapters =new Saved_Cards_Adapters(activity,list,Utils.Frames);
...
*/
    ...
    private void Get_Saved_Items() {
        ...
        UserSavedref.child(android_id).child(Utils.Frames).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void loadDownloaded() {
        try {
            ...
            File fileroot = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).toString()+"/"+getString(R.string.app_name)+"/"+Utils.Frames);
